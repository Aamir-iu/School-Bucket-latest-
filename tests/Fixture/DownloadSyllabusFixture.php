...
/**
 * DownloadSyllabusFixture
 *
 */
class DownloadSyllabusFixture extends TestFixture
{
     ...
     * @var string
     */
    public $table = 'download_syllabus';
    ...
    public $fields = [
        'id_download_syllabus' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        'download' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id_download_syllabus'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'id_download_syllabus' => 1,
            'registration_id' => 1,
            'class_id' => 1,
            'shift_id' => 1,
            'description' => 'Lorem ipsum dolor sit amet',
            'download' => 'Lorem ipsum dolor sit amet',
            'date' => '2017-03-19 13:20:30',
            'created_by' => 1,
            'created_on' => 1489911630
        ],
    ];
}

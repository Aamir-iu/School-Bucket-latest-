...
/**
 * ExamMarksDetailsFixture
 *
 */
class ExamMarksDetailsFixture extends TestFixture
{
    ...
    public $fields = [
        'id_marks_detail' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        'min_marks' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'max_marks' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id_marks_detail'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',

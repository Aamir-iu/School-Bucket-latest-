 ...
 *
 */
class DuesFixture extends TestFixture
{
    ...
    public $fields = [
        'id_dues' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'autoIncrement' => true, 'precision' => null],
        ...
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id_dues'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'amount' => 1.5,
            'fine' => 1.5,
            'fee_date' => '2016-12-10 20:09:53',
            'due_date' => '2016-12-10 20:09:53',
            'created_on' => 1481400593,
            'created_by' => 1
        ],
    ];
}

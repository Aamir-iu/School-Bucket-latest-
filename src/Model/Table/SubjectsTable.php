 ...
 * @property \Cake\ORM\Association\HasMany $Scheduler
 *
...
class SubjectsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->table('subjects');
        $this->displayField('id_subjects');
        $this->primaryKey('id_subjects');

        $this->belongsTo('Orders', [
            'foreignKey' => 'order_id'
        ]);
        $this->hasMany('Scheduler', [
    ...
    public function validationDefault(Validator $validator)
    {
        $validator
            ->integer('id_subjects')
            ->allowEmpty('id_subjects', 'create');

        $validator
            ->allowEmpty('subject_name');

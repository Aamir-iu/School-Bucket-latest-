                        ...
                        <table class="table table-bordered" style="margin-bottom: 0px;">
                          <thead>
                            ...
                            <tr class="bg-gray">
                                ...
                                <th style="width:8%;">Current Fee</th>
                            ...
                            <tr>
                                ...
                                <td style="width:8%;"><?php  echo $details['current_month']; ?></td>
                                <td style="width:8%;"><?php  echo $details['arrears']; ?></td>
                                ...
                                <td style="width:8%;"><?php  echo $this->Number->precision($details['total'],2); ?></td>

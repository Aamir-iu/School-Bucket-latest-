...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $adminCardDatesheet->id_time_table],
                ['confirm' => __('Are you sure you want to delete # {0}?', $adminCardDatesheet->id_time_table)]
            )
        ?></li>
...
<div class="adminCardDatesheet form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Admin Card Datesheet') ?></legend>
        <?php

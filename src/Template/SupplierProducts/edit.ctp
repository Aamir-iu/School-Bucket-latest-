      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Editing an existing  supplier products...</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <?php foreach($suppliers as $supplier):  ?>
                                <option  <?php echo $supplierProduct->id_suppliers === $supplier->id_suppliers ? 'selected' : '' ; ?> value="<?php echo $supplier->id_suppliers; ?>"><?php echo $supplier->supplier_name; ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <?php foreach($products as $product):  ?>
                                <option <?php echo $supplierProduct->id_products === $product->id_products ? 'selected' : '' ; ?> value="<?php echo $product->id_products; ?>"><?php echo $product->product_name; ?></option>
                            <?php endforeach; ?>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <?php foreach($packingtypes as $packingtypes):  ?>
                                <option <?php echo $supplierProduct->packaging_type === $packingtypes->packaging_id ? 'selected' : '' ; ?> value="<?php echo  $packingtypes->packaging_id; ?>"><?php echo $packingtypes->packaging_desc; ?></option>
                            <?php endforeach; ?>

    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">
          ...
          <i class="fa fa-globe"></i>Fee Collected :From  <?php echo date('d-M-Y', strtotime($from)); ?> To  <?php echo date('d-M-Y', strtotime($to)); ?> | <?php echo $tital; ?>
...
<!--                <td><button onclick='javascript:print_invoice(1,<?php  //echo $row['inv_no']; ?>)' class='btn btn-sm btn-success hidden-sm'><i class='fa fa-print'></i> Print</button> </td> -->

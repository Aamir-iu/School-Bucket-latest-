...
<div class="wrapper">
  ...
  <section class="invoice">
        ...
        <h2 class="page-header">
            <span style="display:block; position:relative; text-align:left; ">
               ...
               <?php if($this->request->session()->read('Info.full_logo') === 'No'): ?>
                ...
                <?php else: ?>     
               <?php echo $this->Html->image('logo2.png', ['alt' => 'logo-default', 'style'=>'vertical-align:top;width:50%;']); ?>
    ...
    <div class="row invoice-info">
        ...
        <div class="col-xs-12">
            <?php echo "ID : " . $details['reg_id']; ?>
        </div>  

        <div class="col-xs-12">
            <?php echo "Student's Name : " . $details['name']; ?>
        </div>  

        <div class="col-xs-12">
            <?php echo "Father's Name : " . $details['fname']; ?>
        </div>  

        <div class="col-xs-12">
            <?php echo "Class : " . $details['class']; ?>
        </div>  

        <div class="col-xs-12">
            Invoice #<?php echo $details['inv_no']; ?>
        </div> 

        <div class="col-xs-12">
            Date: <?php echo $details['fee_date']; ?>
        </div> 

        <div class="col-xs-12">
            Payment Mode: <?php echo $details['payment_mode']; ?>
        </div> 
        <!-- /.col -->
    </div>
    <!-- /.row -->

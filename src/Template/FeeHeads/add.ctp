      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Add New Fee Head Here.</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
             <div class="form-body form-horizontal form-bordered form-row-stripped">
                  ...
                  <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <?php foreach($campus as $campus):  ?>
                                <option  value="<?php echo $campus->id_campus; ?>"><?php echo $campus->campus_name; ?></option>
                            <?php endforeach; ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <?php foreach($feetype as $feetype):  ?>
                            <option value="<?php echo $feetype->id_fee_type; ?>"><?php echo $feetype->fee_type_name; ?></option>
                        <?php endforeach; ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" required class="form-control" id="class_fees" name="class_fees" placeholder="Class Fees" value="">
                    </div>
                </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" required class="form-control" id="fine" name="fine" placeholder="Fine" value="">
                    </div>
                </div>    

...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $examResultNormal->id_exam_marks],
                ['confirm' => __('Are you sure you want to delete # {0}?', $examResultNormal->id_exam_marks)]
            )
        ?></li>
...
<div class="examResultNormal form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Exam Result Normal') ?></legend>
        <?php

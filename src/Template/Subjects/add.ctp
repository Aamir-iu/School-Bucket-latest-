            ...
            <div class="box-body">
             <div class="form-body form-horizontal form-bordered form-row-stripped">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" required class="form-control" id="subject_name" name="subject_name" placeholder="Subject" value="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" required class="form-control" id="short_name" name="short_name" placeholder="Subject Short Desc." value="">
                    </div>
                </div>  
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text"  class="form-control" id="subject_desc" name="subject_desc" placeholder="Oral or Writing" value="">
                    </div>
                </div>  
...
<!--                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number"  class="form-control" id="order_id" name="order_id" placeholder="Subject Order ID" value="">
                    </div>
                </div>        -->

                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            <option <?php echo $supplier->supplier_category_id == $cat['id_supplier_category'] ? "selected" : ""; ?> value="<?php echo $cat['id_supplier_category']; ?>"><?php echo $cat['category_name']; ?></option>
                            <?php } ?>
                            </select>
                        </div>
                    </div>

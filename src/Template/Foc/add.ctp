            ...
            <div class="form-body form-horizontal form-bordered form-row-stripped">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="FOC for Qty" class="form-control numeric" name='foc_for_qty' value='' />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="FOC product qty" class="form-control numeric" name='foc_product_qty' value='' />
                        </div>
                    </div>

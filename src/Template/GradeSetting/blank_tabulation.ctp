    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">
          <i class="fa fa-globe"></i>Student Tabulation Blank Report For Teacher Use : <span id="dis_id"></span> | <?= $shift_name; ?>
      ...
      <div class="col-xs-12">
        <table class="" style="width:100%;">
          ...
          <tr>
              ...
              <th style="width:3%;"><?= $subject['subject'] .' '. $subject['sub_desc']; ?>(<?= $subject['max_marks']; ?>)</th>
              <?php endforeach; ?>

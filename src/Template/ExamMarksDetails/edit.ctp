...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $examMarksDetail->id_marks_detail],
                ['confirm' => __('Are you sure you want to delete # {0}?', $examMarksDetail->id_marks_detail)]
            )
        ?></li>
...
<div class="examMarksDetails form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Exam Marks Detail') ?></legend>
        <?php

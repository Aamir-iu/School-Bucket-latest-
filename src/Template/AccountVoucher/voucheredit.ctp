                                    ...
                                    <div class="panel panel-default">
                                        <div class="portlet-title cyan">
                                            <div class="caption">
                                                ...
                                                <span class="caption-subject font-teal-500 bold uppercase"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Edit Voucher: </span>
                                            </div>
                                        </div>

                                        <?php  if(!empty($accountvoucher)) { $voucher_details = $accountvoucher[0]; }?>
                                                        ...
                                                        <div class="form-body form-horizontal form-bordered form-row-stripped">
                                                            <fieldset>
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="date" id="voucher_date" placeholder="Voucher Date" class="form-control" name='voucher_date' value='<?php if(!empty($accountvoucher)){ echo date("Y-m-d", strtotime($voucher_details['voucher_date_created'])); } ?>' />
                                                                    </div>
                                                                </div>
                                                                 ...
                                                                 <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" id="voucher_number" placeholder="Voucher Number" readonly class="form-control disabled" name='voucher_number' value='<?php if(!empty($accountvoucher)){ echo $voucher_details['voucher_number']; } ?>' />
                                                                        <input type="hidden" id="voucher_id"  readonly class="form-control disabled"  value='<?php if(!empty($accountvoucher)){ echo $voucher_details['id_account_voucher']; }?>' />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <select onchange="changetype();" id="voucher_type" disabled name="account_voucher_type_id" class="form-control">
                                                                            <?php foreach ($accountvouchertype as $accountvouchertypes): ?>    
                                                                                <option <?php if(!empty($accountvoucher)){  echo  $voucher_details['vouchertype'] === $accountvouchertypes->account_voucher_type ? 'selected' : '' ; } ?>   value="<?php echo $accountvouchertypes->id_account_voucher_type; ?>"><?php echo $accountvouchertypes->account_voucher_type; ?></option>
                                                                            <?php endforeach; ?>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input type="text" id="voucher_desc" placeholder="Description" class="form-control disabled" name='Description' value='<?php if(!empty($accountvoucher)){ echo  $voucher_details['description']; } ?>' />
                                                                    </div>
                                                                </div> 
                                                                        ...
                                                                        <div onchange="get_business_type();" class="col-md-8">
                                                                            <select id="business_type" name="business_type" <?php if($flag===2){ echo "disabled"; } ?> class="form-control">
                                                                                ...
                                                                                <?php foreach ($business_partners as $business_partners): ?>
                                                                                    <option <?php  if(!empty($accountvoucher)){ echo $voucher_details['bp_type'] === $business_partners->business_type ? 'selected' : '' ; } ?>  value="<?php echo $business_partners->id_business_type; ?>"><?php echo $business_partners->business_type; ?></option>
                                                                                <?php endforeach; ?>
                                                                    ...
                                                                    <div class="form-group clearfix">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            <select id="business_name" name="business_name" <?php if($flag===2){ echo "disabled"; } ?> class="form-control">
                                                                               ...
                                                                               <option <?php if(!empty($accountvoucher)){ echo $voucher_details['bp_name'] === $paymentadvice[0]['sup_name'] ? 'selected' : '' ; }?> value="<?php echo $paymentadvice[0]['sup_id'];  ?>"><?php  echo $paymentadvice[0]['sup_name']; ?><option>
                                                                                <?php endif; ?>
                                                                            </select>
                                                                        </div>
                                                                    </div>
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <select  onchange="get_center_type();" id="cost_center_type" name="cost_center_type" class="form-control">
                                                                                        ...
                                                                                        <?php foreach ($cost_center_type as $cost_center_types): ?>    
                                                                                            <option <?php   if(!empty($accountvoucher)){ echo  $voucher_details['center_type']  === $cost_center_types->cost_center_type ? 'selected' : '' ; }  ?> value="<?php echo $cost_center_types->id_cost_center_type; ?>"><?php echo $cost_center_types->cost_center_type; ?></option>
                                                                                        <?php endforeach; ?>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div class="form-body form-horizontal form-bordered form-row-stripped">
                                                                        <fieldset>
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <select id="paymentmode" name="account_voucher_type_id" class="form-control">
                                                                                        <option <?php echo  $voucher_details['pmode'] === "Cash" ? 'selected' : ''  ?> value="Cash">Cash</option>
                                                                                        <option <?php echo  $voucher_details['pmode'] === "Cheque" ? 'selected' : ''  ?> value="Cheque">Cheque</option>
                                                                                        <option <?php echo  $voucher_details['pmode'] === "Pay Order" ? 'selected' : ''  ?>value="Pay Order">Pay Order</option>
                                                                                        <option <?php echo  $voucher_details['pmode'] === "Credit Card" ? 'selected' : ''  ?>value="Pay Order">Credit Card</option>
                                                                                        <option <?php echo  $voucher_details['pmode'] === "Bank to Cash" ? 'selected' : ''  ?>value="Bank to Cash">Bank to Cash</option>
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" placeholder="Amount" id="amount" class="form-control float-number disabled" name='Amount' value='' />
                                                                                </div>
                                                                            </div> 
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="table-responsive">
                                                                <table id="transactiontable" class="table table-hover table-bordered table-striped">
                                                                    ...
                                                                    <tbody>
                                                                    <?php $i = 1; $trans_id; $debit = 0; $credit = 0; ?>
                                                                    <?php  foreach($accountvoucher as $v_details): ?>

                                                                                <?php if($voucher_details['vouchertype'] === 'Journal Voucher'){  ?>
                                                                                    <tr class="id <?php  echo $i; ?>"> 
                                                                                <?php  }else{ ?>
                                                                                    <tr class="id <?php  echo $i == count($accountvoucher) ? $v_details['taid'] : $v_details['taid'].$i.$i; ?>">
                                                                                <?php  } ?>  

                                                                                    <td class="hidden"><?php  echo $v_details['taid']; ?></td> 
                                                                                    ...
                                                                                    <td class="hidden cctype"><?php  echo $v_details['center_type']; ?></td>  
                                                                                    <td><a href='javascript:void(0);' onclick='loadCostCenterModal($(this));' id='cost_id' data-type='select' data-pk='1' data-value='' data-original-title='Select Cost Center'><?php  echo $v_details['center_name']; ?></a></td>
                                                                                    <td class="hidden ccid"><?php  echo $v_details['cost_id']; ?></td>  
                                                                                    <td><?php  if($v_details['debit'] > 0 ){ echo  $v_details['debit']; } else{ echo  $v_details['credit']; } ?></td>
                                                                                    <td><?php  echo $v_details['remakrs']; ?> </td>

                                                                                    <td  style='text-align:right;'><?php  if($v_details['type']=='Debit'){ echo  intval($v_details['debit']);  $debit += $v_details['debit'];} ?></td>
                                                                                    <td style='text-align:right;'><?php  if($v_details['type']=='Credit'){ echo intval($v_details['credit']); $credit += $v_details['credit'];} ?></td>

                                                                                    <?php if($voucher_details['vouchertype'] == 'Journal Voucher'){  ?>
                                                                                    <td><button onclick='removefromlist(<?php  echo $i; ?>);' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i></button></td>
                                                                                    <?php  }else{ ?>
                                                                                    <td><button onclick='removefromlist(<?php  echo $i === count($accountvoucher) ? $v_details['taid'] : $v_details['taid'].$i.$i; ?>);' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i></button></td>
                                                                                    <?php  } ?>



                                                                                    <?php  $trans_id = $v_details['taid']; ?>
                                                                                </tr>
                                                                ...
                                                                <table id="tbltotals" class="table table-hover table-bordered table-striped">
                                                                    <tbody>
                                                                        ...
                                                                        <td style='text-align:right; font-weight:bold;' class='totaldebit' width='5%'><?php if(isset($debit)){ echo $this->Number->precision($debit,2); } ?></td>
                                                                        <td style='text-align:right; font-weight: bold;' class='totalcredit' width='5%'><?php if(isset($credit)){ echo $this->Number->precision($credit,2); } ?></td>
                                                                        <td style='text-align:right; font-weight: bold;' class='totalcredit' width='6%'></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var check_business_type = '<?php echo $voucher_details['bp_id'];  ?>';
        if(check_business_type === '0' || check_business_type === '100'){

            $('#business_type option:selected').val('<?php echo $voucher_details['bp_id'];?>').change();
            get_business_type();
            $('#business_type option:selected').text('<?php echo $voucher_details['bp_name'];  ?>');
           
            
        }else{
            get_business_type();
          //  $('#business_name option:selected').val('<?php echo $voucher_details['bp_id'];  ?>');
          //  $('#business_name option:selected').text('<?php echo $voucher_details['bp_name'];  ?>');
        }
      
       
        var paymode = '<?php echo  $voucher_details['pm'];  ?>'
        var vt = '<?php echo  $voucher_details['vouchertype'];  ?>'
        
        if(vt !== 'Journal Voucher'){
            if(paymode === 'Cash'){
                    ...
                    success: function (data) {
                        ...
                        if (mdata.length > 0) {
                            ...
                            for (var x = 0; x < mdata.length; x++) {
                                var selected = parseInt(mdata[x].id_transaction_account) === parseInt(tid) ? 'selected' : '';
                                html += ' <option '+ selected +' value="' + mdata[x].id_transaction_account + '">' + mdata[x].transaction_account_number + '|'+ mdata[x].transaction_account_name + '</option>';
                            }
        ...
        if ($("#cash").is(":checked") || $("#bank").is(":checked")) {
            ...
            if (transactiontypeid === "Debit") {
                ...
                if(transactionaccount_name.indexOf("Tax") > -1){
                    ...
                    mhtml += "<tr class='id " + counter + "'><td class='hidden'>" + transactionaccount_id + "</td><td>" + transactionaccount_number + "</td><td>" + transactionaccount_name + "</td><td>" + paymentmode + "</td><td class='hidden cctype'>" + cost_center_type + "</td><td><a href='javascript:void(0);' onclick='loadCostCenterModal($(this));' id='cost_id' data-type='select' data-pk='1' data-value='' data-original-title='Select Cost Center'>" + cost_center + "</a></td><td class='hidden ccid'>" + cost_center_id + "</td><td>" + instumentno + "</td><td>" + amount + "</td><td>" + remarks + "</td><td style='text-align:right;' class='debit'>" + amount + "</td><td></td><td><button onclick='removefromlist(" + counter + ");' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i></button></td></tr>";
                }else{
    ...
    function add_transaction() {
        ...
        if (tDebit == tCredit) {
            ...
            if (TableData.length > 0) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $this->Url->build(['action' => 'voucheredit']); ?>",
                    dataType: 'json',
                    data: {transactions: TableData, voucher_date: voucher_date, voucher_type: voucher_type, voucher_desc: voucher_desc,
                        bn_name: business_name, bn_id: business_name_id, bn_type: business_type,vs:vstatus,voucher_number:voucher_number,voucher_id:voucher_id},
                    success: function (data) {
    ...
    function get_business_type() {
        ...
        var bpid = '<?php echo $voucher_details['bp_id'];  ?>';
        $.ajax({
            type: "POST",
            ...
            success: function (data) {
                ...
                if (mdata.length > 0) {
                    ...
                    for (var x = 0; x < mdata.length; x++) {
                        var selected = bpid == mdata[x].id ? 'selected' : '';
                        html += '<option '+ selected +' value="' + mdata[x].id + '" tax="'+ mdata[x].tax +'">' + mdata[x].name + ' ( Tax applied :  '+ mdata[x].tax +'% )</option>';
                    }

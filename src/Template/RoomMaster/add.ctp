      ...
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Add New Room/Hall.</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
             <div class="form-body form-horizontal form-bordered form-row-stripped">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" required class="form-control" id="subject_name" name="room_name" placeholder="Room Name" value="">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" required class="form-control" id="short_name" name="room_desc" placeholder="Desc." value="">
                    </div>
                </div>  
